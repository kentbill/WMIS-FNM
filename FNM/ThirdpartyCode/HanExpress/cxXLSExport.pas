...
type
  ...
  { TcxCacheExportXLS }
  TcxXLSExportProvider = class(TcxCustomExportProvider, IcxExportProvider)
  private
  ...
  TcxXLSCell = packed record
    ...
    case Integer of
      ...
      5: (StrLen: Word; case StrType: Boolean of
                           False: (StrDataA: array[0..255] of Char);
                           True: (StrDataW: array[0..255 shr 1] of WideChar));
...
const
 ...
 ($93, $02, $04, $00, $10, $80, $03, $FF, $93, $02, $04, $00, $11, $80, $06, $FF,
  $93, $02, $04, $00, $12, $80, $04, $FF, $93, $02, $04, $00, $13, $80, $07, $FF,
  $93, $02, $04, $00, $00, $80, $00, $FF, $93, $02, $04, $00, $14, $80, $05, $FF);
...
begin
  FSheetName := ExtractFileName(ChangeFileExt(AFileName, ''));
...
procedure TcxXLSExportProvider.SetCellDataString(const ACol, ARow: Integer;
  ...
  begin
    Result := cxStrToUnicode(AText, GetCellStyle(ACol, ARow)^.FontCharset);
  end;
      ...
      begin
        ...
        begin
          if ALen = 0 then
            ...
            FCells.SetCellDataStringA(ACol, ARow, AText);
        end
        else
          FCells.SetCellDataSSTString(ACol, ARow, FSST.Add(AText));
      end;
    end;
  end;
end;
    ...
    begin
      ...
      begin
        if ALen = 0 then
          ...
          FCells.SetCellDataStringW(ACol, ARow, AText);
      end
      else
        FCells.SetCellDataSSTString(ACol, ARow, FSST.Add(AText));
    end;
...
begin
  if xlsCheckPos(ACol, ARow) then
    FCells.GetCell(ACol, ARow)^.XF := AStyleIndex + $10;
end;
...
//------------------------------------------------------------------------------
  ...
  {$ENDIF}
    ...
    varString:
    begin
      APrevValue := NeedStringParse;
      NeedStringParse := True;
      SetCellDataString(ACol, ARow, cxValidateStr(AValue));
      NeedStringParse := APrevValue;
    end;
{$IFDEF DELPHI6}
  {$IFNDEF NONDB}
  else
...
begin
  with AStyle do
  begin
    ASize := StrLen(AStyle.FontName) shl 1 + 16;
    AWName := AStyle.FontName;
    ...
    PInteger(@AFont^[ASize + 2])^ := GetHashCode(AFont^[2], ASize);
  end;
...
begin
  ...
  PInteger(@XF^[22])^ := GetHashCode(XF^[2], 20);
...
begin
  ...
  FStream.WriteBuffer(W[1], Length(FSheetName) * 2);
  //
...
const
  AFormats: array[0..3] of Word = ($16, $0E, $15, $5);
begin
...
begin
  ...
  AHashCode := GetHashCode(Pointer(@AString[1])^, ASrcLen);
...
procedure TcxXLSSharedStringTable.InsertStr(const AString: WideString);
  ...
  begin
    ...
    begin
      HashCode := GetHashCode(Pointer(@AString[1])^, ASize);
      StrSize := ASize;
      Block := ABlock;
      Offset := AOffset;
    end;
...
begin
  ...
  PInteger(@NewData[DataSize + SizeOf(Word)])^ := GetHashCode(AData, DataSize);
